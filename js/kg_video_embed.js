function kg_set_mp4_src(mp4_srcs) {
...
function kg_SetVideo(source, width, height) {
	jQuery('#kg_GalleryVideo').attr('src', source);
	jQuery('#kg_GalleryVideo').attr('width', parseInt(width)+20);
	jQuery('#kg_GalleryVideo').attr('height', parseInt(height)+20);
	jQuery('#kg_GalleryPlayerDiv').dialog("option", "width", parseInt(width)+30);
	jQuery('#kg_GalleryPlayerDiv').closest('.ui-dialog').height(parseInt(height))
	//jQuery('#kg_GalleryPlayerDiv').dialog("option", "height", parseInt(height)+30);
	jQuery('#kg_GalleryPlayerDiv').dialog('open');
	jQuery('.ui-widget-overlay').click(function () { $('#kg_GalleryPlayerDiv').dialog('close'); });
}

function kg_video_counter(id, plays, ends, event) {
