	...
	public function register_videopack_block_context( $metadata ) {
		...
		$uses_context = array_merge(
			...
			array(
				...
				'videopack/skip_buttons',
				'videopack/skip_forward',
				'videopack/skip_backward',
				'videopack/right_click',
				...
				'videopack/align',
				'videopack/enable_collection_video_limit',
				'videopack/collection_video_limit',
				'videopack/embed_method',
				'videopack/isPreview',
				'videopack/videopack',
				'videopack/duotone',
				'videopack/style',
				'videopack/loopDuotoneId',
				'videopack/fixed_aspect',
				'videopack/fullwidth',
				'videopack/rotate',
				'videopack/default_ratio',
				'videopack/onPageChange',
			)
		);
				/**
