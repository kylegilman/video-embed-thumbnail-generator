...
= 4.1 May 18, 2013 =
* Updated Video.js to version 4.0 and created a new skin that approximates the old one. Older versions of Video.js have some security holes, so this update is highly recommended.
