...
const EncodeProgress = ({
    ...
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("span", {
          children: (0,external_wp_i18n_namespaceObject.__)('Elapsed:', 'video-embed-thumbnail-generator') + ' ' + convertToTimecode(formatData.progress.elapsed)
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("span", {
          children: (0,external_wp_i18n_namespaceObject.__)('Remaining:', 'video-embed-thumbnail-generator') + ' ' + convertToTimecode(formatData.progress.remaining)
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("span", {
  ...
  if (formatData?.status === 'failed' && formatData?.error_message) {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [(0,external_wp_i18n_namespaceObject.sprintf)((0,external_wp_i18n_namespaceObject.__)('Error: %s', 'video-embed-thumbnail-generator'), formatData.error_message), formatData.job_id && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
...
/* unused harmony import specifier */ var getFilename;
...
const getVideoFormats = async attachmentId => {
  const pre = applyFilters('videopack.utils.pre_getVideoFormats', undefined, attachmentId);
  if (typeof pre !== 'undefined') {
    return pre;
  }
  try {
    ...
    return applyFilters('videopack.utils.getVideoFormats', response, attachmentId);
  } catch (error) {
...
const enqueueJob = async (attachmentId, src, formats) => {
  const pre = applyFilters('videopack.utils.pre_enqueueJob', undefined, attachmentId, src, formats);
  if (typeof pre !== 'undefined') {
    return pre;
  }
  try {
...
const getSettings = async () => {
  ...
  try {
    const allSettings = await apiFetch({
      path: '/wp/v2/settings'
    });
...
const startBatchProcess = async (type, additionalData = {}) => {
  const pre = applyFilters('videopack.utils.pre_startBatchProcess', undefined, type, additionalData);
  if (typeof pre !== 'undefined') {
    return pre;
  }
  try {
...
const JobRow = (0,external_wp_element_namespaceObject.memo)(({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("tr", {
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("td", {
      ...
      children: job.user_name || (0,external_wp_i18n_namespaceObject.__)('N/A', 'video-embed-thumbnail-generator')
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("td", {
      ...
      children: job.status !== 'encoding' && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
        ...
        children: (0,external_wp_i18n_namespaceObject.__)('Clear', 'video-embed-thumbnail-generator')
      })
    })]
  }, job.id);
});
const EncodeQueue = () => {
  ...
  const fetchQueue = async () => {
    try {
      ...
      setMessage({
        ...
        (0,external_wp_i18n_namespaceObject.__)('Failed to load queue: %s', 'video-embed-thumbnail-generator'), error.message || error.code)
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const handleToggleQueue = async () => {
    ...
    try {
      ...
      setMessage({
        type: 'error',
        text: (0,external_wp_i18n_namespaceObject.sprintf)(/* translators: %s is an error message */
        (0,external_wp_i18n_namespaceObject.__)('Failed to toggle queue: %s', 'video-embed-thumbnail-generator'), error.message || error.code)
      });
    } finally {
  ...
  const handleClearQueue = async type => {
    ...
    try {
      ...
      setMessage({
        type: 'error',
        text: (0,external_wp_i18n_namespaceObject.sprintf)(/* translators: %s is an error message */
        (0,external_wp_i18n_namespaceObject.__)('Failed to clear queue: %s', 'video-embed-thumbnail-generator'), error.message || error.code)
      });
    } finally {
      setIsClearing(false);
    }
  ...
  const handleDeleteJob = async jobId => {
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: (0,external_wp_i18n_namespaceObject.__)('Job deleted.', 'video-embed-thumbnail-generator')
      });
      fetchQueue();
    } catch (error) {
      console.error('Error deleting job:', error);
      setMessage({
        type: 'error',
        text: (0,external_wp_i18n_namespaceObject.sprintf)((0,external_wp_i18n_namespaceObject.__)('Error deleting job: %s', 'video-embed-thumbnail-generator'), error.message)
      });
    } finally {
  ...
  const handleRemoveJob = async jobId => {
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: (0,external_wp_i18n_namespaceObject.__)('Job removed from queue.', 'video-embed-thumbnail-generator')
      });
      fetchQueue();
    } catch (error) {
      console.error('Error removing job:', error);
      setMessage({
        type: 'error',
        text: (0,external_wp_i18n_namespaceObject.sprintf)((0,external_wp_i18n_namespaceObject.__)('Error removing job: %s', 'video-embed-thumbnail-generator'), error.message)
      });
    } finally {
      setDeletingJobId(null);
    }
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h1", {
      children: (0,external_wp_i18n_namespaceObject.__)('Videopack Encode Queue', 'video-embed-thumbnail-generator')
      ...
      children: itemToActOn?.action === 'clear' ? (0,external_wp_i18n_namespaceObject.sprintf)((0,external_wp_i18n_namespaceObject.__)('Are you sure you want to clear %s jobs?', 'video-embed-thumbnail-generator'), itemToActOn.type) : (0,external_wp_i18n_namespaceObject.__)('Are you sure you want to remove this job?', 'video-embed-thumbnail-generator')
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_wp_components_namespaceObject.Button, {
          ...
          }), isQueuePaused ? (0,external_wp_i18n_namespaceObject.__)('Play Queue', 'video-embed-thumbnail-generator') : (0,external_wp_i18n_namespaceObject.__)('Pause Queue', 'video-embed-thumbnail-generator')]
          ...
          isBusy: isClearing,
          children: (0,external_wp_i18n_namespaceObject.__)('Clear Completed', 'video-embed-thumbnail-generator')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
          variant: "tertiary",
          isDestructive: true,
          onClick: () => openConfirmDialog('clear', {
          ...
          isBusy: isClearing,
          children: (0,external_wp_i18n_namespaceObject.__)('Clear All', 'video-embed-thumbnail-generator')
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("thead", {
          children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("tr", {
            children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('Order', 'video-embed-thumbnail-generator')
            }), isMultisite && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('Site', 'video-embed-thumbnail-generator')
            }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('User', 'video-embed-thumbnail-generator')
            }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('Thumbnail', 'video-embed-thumbnail-generator')
            }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('File', 'video-embed-thumbnail-generator')
            }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('Format', 'video-embed-thumbnail-generator')
            }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('Status', 'video-embed-thumbnail-generator')
            }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("th", {
              children: (0,external_wp_i18n_namespaceObject.__)('Actions', 'video-embed-thumbnail-generator')
            })]
          })
          ...
          children: [isLoading && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("tr", {
            children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("td", {
              ...
              children: (0,external_wp_i18n_namespaceObject.__)('Loading queue…', 'video-embed-thumbnail-generator')
            })
          }), !isLoading && queueData.length === 0 && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("tr", {
            children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("td", {
              colSpan: isMultisite ? 8 : 7,
              children: (0,external_wp_i18n_namespaceObject.__)('The encode queue is empty.', 'video-embed-thumbnail-generator')
            })
