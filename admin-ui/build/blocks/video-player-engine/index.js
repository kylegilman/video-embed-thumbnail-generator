...
function Edit(props) {
  ...
  const blockProps = (0,external_wp_blockEditor_namespaceObject.useBlockProps)({
    className: `videopack-video-player-engine-block videopack-wrapper ${skin} ${hasTitleFeatures ? 'videopack-video-title-visible' : ''} ${getEffectiveValue('play_button_color', {}, contextValue) ? 'videopack-has-play-button-color' : ''} ${getEffectiveValue('play_button_secondary_color', {}, contextValue) ? 'videopack-has-play-button-secondary-color' : ''}`,
    style: {
  ...
  const attributes = (0,external_wp_element_namespaceObject.useMemo)(() => {
    return {
      'videopack/postId': resolvedPostId,
      ...
      play_button_secondary_color: getEffectiveValue('play_button_secondary_color', {}, contextValue),
...
const block_namespaceObject = /*#__PURE__*/JSON.parse('{"UU":"videopack/video-player-engine"}');
