...
function Edit({
  ...
  const {
    postId,
    postType,
    'videopack/caption': contextCaption
  } = context;
  const {
    fetchedExcerpt
    ...
    const record = select('core').getEntityRecord('postType', postType || 'attachment', postId);
    return {
      fetchedExcerpt: record?.excerpt?.rendered || record?.caption?.rendered || ''
    };
  }, [postId, postType]);
  const {
    resolved: vpContext
  } = (0,_hooks_useVideopackContext__WEBPACK_IMPORTED_MODULE_4__["default"])(attributes, context);
  const displayCaption = (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_3__.decodeEntities)(manualCaption || (vpContext.prioritizePostData ? fetchedExcerpt || contextCaption : contextCaption || fetchedExcerpt) || (vpContext.isPreview ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Sample Video Caption', 'video-embed-thumbnail-generator') : ''));
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
      ...
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Enter Caption…', 'video-embed-thumbnail-generator')
    })
  });
}
...
/***/ "./src/blocks/caption/block.json"
/*!***************************************!*\
  !*** ./src/blocks/caption/block.json ***!
  \***************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"videopack/caption","title":"Videopack Caption","category":"media","parent":["videopack/player-container","videopack/loop"],"icon":"text","description":"Add a caption to your video.","usesContext":["postId","postType"],"attributes":{"caption":{"type":"string"},"isPreview":{"type":"boolean","default":false}},"example":{"attributes":{"isPreview":true}},"supports":{"html":false,"reusable":false,"multiple":true,"interactivity":{"clientNavigation":true}},"textdomain":"video-embed-thumbnail-generator","editorScript":"file:./index.js"}');
...
(() => {
/*!*************************************!*\
  !*** ./src/blocks/caption/index.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/blocks/caption/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./save */ "./src/blocks/caption/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/caption/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  icon: _assets_icon__WEBPACK_IMPORTED_MODULE_4__.videopackCaption,
  /**
   * @see ./edit.js
   */
