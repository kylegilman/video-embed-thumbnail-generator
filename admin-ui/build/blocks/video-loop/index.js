...
function VideoThumbnailPreview({
  ...
  const vpContext = (0,_hooks_useVideopackContext__WEBPACK_IMPORTED_MODULE_2__["default"])({}, context);
  ...
  const containerClass = `gallery-thumbnail videopack-gallery-item wp-block wp-block-videopack-thumbnail ${effectiveEmbedMethod === 'Video.js' ? effectiveSkin || '' : ''} ${resolvedDuotoneClass || ''} ${play_button_color ? 'videopack-has-play-button-color' : ''} ${play_button_secondary_color ? 'videopack-has-play-button-secondary-color' : ''} ${(vpContext.resolved.linkTo || propLinkTo) !== 'none' ? 'has-link' : ''}`.trim();
...
function VideoDuration({
  ...
  const {
    ...
    return {
      ...
      isResolving: isResolvingSelector('getEntityRecord', ['postType', 'attachment', attachmentId])
    };
  }, [attachmentId]);
...
function Edit({
  ...
  } = (0,_hooks_useVideoQuery__WEBPACK_IMPORTED_MODULE_14__["default"])(vpContext.videos ? null : queryAttributes);
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps)({
    className: `videopack-video-loop layout-${layout} columns-${columns} ${isPreviewResolving && !isSaving && !isAutosaving ? 'is-loading' : ''} ${isEditingAllPages ? 'is-editing-all-pages' : ''}`,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_23__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_23__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_23__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, {
      ...
      ...blockProps,
      style: computedStyle,
      children: !videos ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_23__.jsx)("div", {
