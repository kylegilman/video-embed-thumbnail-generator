"use strict";
(globalThis["webpackChunkvideopack_admin"] = globalThis["webpackChunkvideopack_admin"] || []).push([["loop-sortable-grid"],{
...
var drag_handle_default = /* @__PURE__ */ (0,external_ReactJSXRuntime_.jsx)(external_wp_primitives_.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ (0,external_ReactJSXRuntime_.jsx)(external_wp_primitives_.Path, { d: "M8 7h2V5H8v2zm0 6h2v-2H8v2zm0 6h2v-2H8v2zm6-14v2h2V5h-2zm0 8h2v-2h-2v2zm0 6h2v-2h-2v2z" }) });
...
var pencil_default = /* @__PURE__ */ (0,external_ReactJSXRuntime_.jsx)(external_wp_primitives_.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ (0,external_ReactJSXRuntime_.jsx)(external_wp_primitives_.Path, { d: "m19 7-3-3-8.5 8.5-1 4 4-1L19 7Zm-7 11.5H5V20h7v-1.5Z" }) });

//# sourceMappingURL=pencil.mjs.map

// EXTERNAL MODULE: ./node_modules/@wordpress/icons/build-module/library/close.mjs
var library_close = __webpack_require__(2023);
;// ./node_modules/@wordpress/icons/build-module/library/create.mjs
// packages/icons/src/library/create.tsx


var create_default = /* @__PURE__ */ (0,external_ReactJSXRuntime_.jsx)(external_wp_primitives_.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ (0,external_ReactJSXRuntime_.jsx)(external_wp_primitives_.Path, { d: "M16 11.2h-3.2V8h-1.6v3.2H8v1.6h3.2V16h1.6v-3.2H16z" }) });
...
function useRects(elements, measure) {
  ...
  const [rects, setRects] = (0,external_React_.useState)(defaultValue$2);
...
const DndContext = /*#__PURE__*/(0,external_React_.memo)(function DndContext(_ref) {
  ...
  const store = (0,external_React_.useReducer)(reducer, undefined, getInitialState);
  ...
  const activationCoordinates = (0,external_React_.useMemo)(() => activatorEvent ? getEventCoordinates(activatorEvent) : null, [activatorEvent]);
  ...
  const activeSensorRef = (0,external_React_.useRef)(null);
...
;// ./src/blocks/loop/SortableGrid.js
...
function SortableItem({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_.jsxs)("figure", {
    ref: setNodeRef,
    style: style,
    ...sortableAttributes,
    className: `videopack-collection-item videopack-hover-trigger ${isActive && !isPreview ? 'is-editable' : 'is-preview'} ${isDragging ? 'is-dragging' : ''}`,
    children: [children, /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("button", {
      className: "videopack-drag-handle",
      ...listeners,
      title: (0,external_wp_i18n_.__)('Drag to reorder', 'video-embed-thumbnail-generator'),
      ...
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("button", {
        ...
        title: (0,external_wp_i18n_.__)('Edit', 'video-embed-thumbnail-generator'),
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_wp_components_.Icon, {
          icon: pencil_default
        })
      })
      ...
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("button", {
        ...
        title: (0,external_wp_i18n_.__)('Remove', 'video-embed-thumbnail-generator'),
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_wp_components_.Icon, {
          icon: library_close/* default */.A
        })
      })
    }), !isActive && isHoveringGallery && /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("button", {
...
function SortableGrid({
  ...
  const [optimisticVideos, setOptimisticVideos] = (0,external_wp_element_.useState)(null);
  (0,external_wp_element_.useEffect)(() => {
    setOptimisticVideos(null);
  }, [videos]);
  const displayVideos = optimisticVideos || videos;
  const handleDragEnd = (0,external_wp_element_.useCallback)(async event => {
    const {
      active,
      over
    } = event;
    if (active && over && active.id !== over.id) {
      const displayOldIndex = videos.findIndex(v => (v.attachment_id || v.id) === active.id);
      const displayNewIndex = videos.findIndex(v => (v.attachment_id || v.id) === over.id);
      if (displayOldIndex !== -1 && displayNewIndex !== -1) {
        setOptimisticVideos(arrayMove(videos, displayOldIndex, displayNewIndex));
        onReorderStart?.();
      }
      let fullIds = [];
  ...
  }, [queryAttributes, videos, parentClientId, updateBlockAttributes, previewPostId, onReorderStart]);
  return /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(DndContext, {
    sensors: sensors,
    collisionDetection: closestCenter,
    onDragEnd: handleDragEnd,
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(SortableContext, {
      items: displayVideos.map((v, i) => v.attachment_id || `temp-${i}`),
      strategy: rectSortingStrategy,
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("div", {
        ...
        children: displayVideos.map(video => {
          ...
          return /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(SortableItem, {
            ...
            children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_wp_blockEditor_.BlockContextProvider, {
              ...
              children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsxs)("div", {
                ...
                children: [isActive && /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_wp_blockEditor_.InnerBlocks, {
                  templateLock: false,
                  renderAppender: showLoopAppender ? external_wp_blockEditor_.InnerBlocks.ButtonBlockAppender : false
                }), /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(LoopItemPreview/* default */.A, {
