...
const SingleVideoBlock = ({
  ...
  const playerAttributes = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    ...
    if (attachment) {
      ...
      if (!externalSourceGroups || Object.keys(externalSourceGroups).length === 0) newPlayerAttributes.sources = [{
        src
      }];
    }
