...
const VideoJS = props => {
  const videoRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const playerRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const {
    options,
    skin
  } = props;
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    if (!playerRef.current) {
      ...
      playerRef.current = video_js__WEBPACK_IMPORTED_MODULE_0___default()(videoElement, options, () => {
...
const VideoPlayer = ({
  ...
  const [metaBarVisible, setMetaBarVisible] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
