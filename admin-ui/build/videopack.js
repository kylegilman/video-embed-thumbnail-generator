...
// NAMESPACE OBJECT (decoupled): ./src/assets/icon.js
...
// NAMESPACE OBJECT (decoupled): ./src/utils/video-capture.js
...
// NAMESPACE OBJECT (decoupled): ./src/utils/utils.js
...
const testEncodeCommand = async (codec, resolution) => {
   ...
   */
  const pre = (0,external_wp_hooks_namespaceObject.applyFilters)('videopack.utils.pre_testEncodeCommand', undefined, codec, resolution);
  if (typeof pre !== 'undefined') {
    return pre;
  }
  try {
