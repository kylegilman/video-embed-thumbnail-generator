...
const VideoPlayer = ({
  ...
  const decodedAttributes = (0,external_wp_element_namespaceObject.useMemo)(() => ({
    ...attributes,
    title: attributes.title ? (0,external_wp_htmlEntities_namespaceObject.decodeEntities)(attributes.title) : attributes.title
  }), [attributes]);
  const {
    autoplay,
    controls = true,
  ...
  const videoRef = (0,external_wp_element_namespaceObject.useRef)(null);
  const playerInstanceRef = (0,external_wp_element_namespaceObject.useRef)(null);
  const wrapperRef = (0,external_wp_element_namespaceObject.useRef)(null);
  const allSources = (0,external_wp_element_namespaceObject.useMemo)(() => {
  ...
  const videoJsOptions = (0,external_wp_element_namespaceObject.useMemo)(() => {
    const isVjs = (0,external_wp_hooks_namespaceObject.applyFilters)('videopack_is_videojs_player', embed_method === 'Video.js', embed_method);
    if (!isVjs) {
      return null;
    }
    const options = {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [(() => {
        ...
        return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(PlayerComponent, {
          options: PlayerComponent === VideoJs || PlayerComponent === VideoPlayer_WpMejsPlayer ? videoJsOptions || genericPlayerOptions : undefined,
...
const AttachmentPreview = ({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(PreviewIframe_PreviewIframe, {
