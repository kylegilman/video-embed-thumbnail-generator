...
/* harmony export */ });
/* harmony import */ var _titleDownloadBlock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./titleDownloadBlock */ "./src/utils/titleDownloadBlock.js");
/**
...
const getListTemplate = options => {
  ...
  if (showTitleBar) {
    engineChildren.push(['videopack/title', {}, (0,_titleDownloadBlock__WEBPACK_IMPORTED_MODULE_0__.getTitleInnerTemplate)(!!options?.downloadlink, !!options?.embedcode)]);
  }
...
/* harmony import */ var _utils_templates__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/templates */ "./src/utils/templates.js");
/* harmony import */ var _utils_titleDownloadBlock__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/titleDownloadBlock */ "./src/utils/titleDownloadBlock.js");
...
(function () {
  ...
  const PlaceHolderWrapper = ({
    ...
    if (type === 'Video') {
      ...
      const engineChildren = [];
      if (showTitleBar) {
        engineChildren.push(['videopack/title', {}, (0,_utils_titleDownloadBlock__WEBPACK_IMPORTED_MODULE_4__.getTitleInnerTemplate)(!!mergedAttributes.downloadlink, !!mergedAttributes.embedcode)]);
      }
      ...
      template = (0,_utils_templates__WEBPACK_IMPORTED_MODULE_3__.getGridTemplate)(mergedAttributes);
    } else {
      template = (0,_utils_templates__WEBPACK_IMPORTED_MODULE_3__.getListTemplate)(mergedAttributes);
    }
    const contextValue = {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
      ...
      children: [videopack_config?.globalStyles && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)("style", {
        dangerouslySetInnerHTML: {
          __html: videopack_config.globalStyles
        }
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_components_Preview__WEBPACK_IMPORTED_MODULE_2__.TemplatePreview, {
