...
const VideoSettings = ({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_.jsxs)("div", {
    ...
    }), (0,external_wp_hooks_.applyFilters)('videopack.videoSettings.panels', [], {
      attributes,
      setAttributes,
      options,
      displayAttributes,
    ...
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsxs)(external_wp_components_.PanelBody, {
      ...
      children: [showFailedNotice && Number(videoData?.record?.meta?.['_videopack_browser_thumb_failed']) === 1 && /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_wp_components_.Notice, {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("p", {
          ...
          children: spriteTiles.map((src, index) => /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)("img", {
            src: src,
            alt: ""
          }, index))
        })]
...
const AdditionalFormats = ({
  ...
  const fetchVideoFormats = (0,external_wp_element_.useCallback)(async (signal = null) => {
    ...
    try {
      ...
      setEncodeMessage((0,external_wp_i18n_.sprintf)((0,external_wp_i18n_.__)('Error: %s', 'video-embed-thumbnail-generator'), errorMessage));
      setVideoFormats({});
    } finally {
      setIsLoading(false);
    }
  ...
  const groupedFormats = videoFormats ? (0,external_wp_hooks_.applyFilters)('videopack.grouped_formats', Object.values(videoFormats).reduce((acc, format) => {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_ReactJSXRuntime_.Fragment, {
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_.jsxs)(external_wp_components_.PanelBody, {
      ...
      children: [encodeMessage && /*#__PURE__*/(0,external_ReactJSXRuntime_.jsx)(external_wp_components_.Notice, {
        ...
        children: [(0,external_wp_hooks_.applyFilters)('videopack.AdditionalFormats.extraContent', null, {
          videoFormats,
          options,
          parentId
