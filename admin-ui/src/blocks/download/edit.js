...
export default function Edit( {
	...
	const blockProps = useBlockProps( {
		className: `videopack-download-block videopack-download-wrapper ${
			vpContext.classes
		...
		} has-text-align-${ finalTextAlign } mode-${ downloadMode }`,
		style: {
			...vpContext.style,
			display: 'inline-flex',
			alignItems: 'center',
	...
	const triggerClassName = `videopack-download-trigger videopack-icons style-button${
		isOpen ? ' is-active' : ''
	}`;
	const linkClassName =
		'videopack-download-link videopack-icons style-button';
			...
			<BlockControls>
				...
				>
					...
					<ToolbarButton
						...
						onClick={ () =>
							setAttributes( { downloadMode: 'menu' } )
						}
			...
			<div { ...blockProps }>
				{ downloadMode === 'menu' ? (
					...
					>
						...
						<div
							className={ `videopack-download-dropdown-menu${
								isOpen ? ' is-visible' : ''
							}` }
