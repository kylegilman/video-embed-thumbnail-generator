...
const videopackGallery = (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
		...
		/>
		<g transform="rotate(-5.65 92.234 131.62)">
			<circle
				cx={92.16}
				cy={131.51}
				r={34.87}
		...
		/>
		<g transform="rotate(-5.65 309.192 131.66)">
			<circle
				cx={308.89}
				cy={131.51}
				r={34.87}
		...
		/>
		<g transform="rotate(-5.65 92.268 268.846)">
			<circle
				cx={92.16}
				cy={268.58}
				r={34.87}
		...
		/>
		<g transform="rotate(-5.65 309.13 268.78)">
			<circle
				cx={308.89}
				cy={268.58}
				r={34.87}
...
const videopackList = (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
		...
		/>
		<g transform="rotate(-5.65 205.384 57.57)">
			<circle
				cx={205.16}
				cy={57.53}
				r={37.85}
		...
		/>
		<g transform="rotate(-5.65 205.365 199.974)">
			<circle
				cx={205.16}
				cy={199.85}
				r={37.85}
		...
		/>
		<g transform="rotate(-5.65 205.392 341.466)">
			<circle
				cx={205.16}
				cy={341.17}
				r={37.85}
...
const videopackPlayButton = (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
		<g transform="rotate(-45 205.37 193.523)">
			<circle
				cx={205.37}
				cy={193.52}
				r={87.51}
...
const videopackWatermark = (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
		...
		>
			<g transform="rotate(-45 201.506 200.804)">
				<circle
					cx={201.51}
					cy={200.8}
					r={121.45}
