...
function kgvid_callffmpeg() {
	...
	if ( $options['ffmpeg_exists'] == true ) {
		...
		if ( $action == "submit" ) { kgivd_save_singleurl_poster($parent_id, $poster, $movieurl, $set_featured); }
	}
	else {
