...
function kgvid_video_embed_enqueue_styles() {
	...
	if ( $options['embed_method'] == "Video.js v7" ) {
		wp_register_script( 'video-js', plugins_url("", __FILE__).'/video-js/v7/video.min.js', '', '7.10.2', true );
		...
		wp_enqueue_style( 'video-js', plugins_url("", __FILE__).'/video-js/v7/video-js.min.css', '', '7.10.2' );
